...
s.source       = { :http => "https://s3.amazonaws.com/chalkiosapp/ads_framework/1.0.2/CDAds.framework-1.zip" }
s.resources = "CDAds.framework/CDAds.bundle", "CDAds.framework/cdads.momd/*"
s.frameworks = 'UIKit', 'CoreLocation', 'CoreTelephony', 'AdSupport', 'Security', 'CoreData', 'libsqlite3'
s.requires_arc = true
